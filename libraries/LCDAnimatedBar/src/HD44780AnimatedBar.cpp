...
static const uint8_t HD44780AnimatedBar::charBarLinesBitmap[][8] = {
...
static const uint8_t HD44780AnimatedBar::charBarNeedlesBitmap[][8] = {
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04}, // char 0 
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x04}, // char 1
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x04, 0x04}, // char 2
	{0x00, 0x00, 0x00, 0x00, 0x04, 0x04, 0x04, 0x04}, // char 3
	{0x00, 0x00, 0x00, 0x04, 0x04, 0x04, 0x04, 0x04}, // char 4
	{0x00, 0x00, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04}, // char 5
	{0x00, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04}, // char 6
	{0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04}, // char 7
};

static const uint8_t HD44780AnimatedBar::charBarBubblesBitmap[][8] = {
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15}, // char 0 
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15}, // char 1
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x00, 0x15}, // char 2
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x00, 0x15}, // char 3
	{0x00, 0x00, 0x00, 0x15, 0x00, 0x15, 0x00, 0x15}, // char 4
	{0x00, 0x00, 0x00, 0x15, 0x00, 0x15, 0x00, 0x15}, // char 5
	{0x00, 0x15, 0x00, 0x15, 0x00, 0x15, 0x00, 0x15}, // char 6
	{0x00, 0x15, 0x00, 0x15, 0x00, 0x15, 0x00, 0x15}, // char 7
};

static const uint8_t HD44780AnimatedBar::charBarMoreBubblesBitmap[][8] = {
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15}, // char 0 
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0A, 0x15}, // char 1
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x0A, 0x15}, // char 2
	{0x00, 0x00, 0x00, 0x00, 0x0A, 0x15, 0x0A, 0x15}, // char 3
	{0x00, 0x00, 0x00, 0x15, 0x0A, 0x15, 0x0A, 0x15}, // char 4
	{0x00, 0x00, 0x0A, 0x15, 0x0A, 0x15, 0x0A, 0x15}, // char 5
	{0x00, 0x15, 0x0A, 0x15, 0x0A, 0x15, 0x0A, 0x15}, // char 6
	{0x0A, 0x15, 0x0A, 0x15, 0x0A, 0x15, 0x0A, 0x15}, // char 7
};
...
static void HD44780AnimatedBar::createChars(HD44780AnimatedBar::bar_type_t barType) {
  for ( int i = 0; i < LCDAnimatedBar::charBitmapSize; i++ ) {
    switch(barType) {
      case HD44780AnimatedBar::BAR_LINES:        lcd->createChar ( i, (uint8_t *)charBarLinesBitmap[i] ); break;
      ...
      default:                                   lcd->createChar ( i, (uint8_t *)charBarLinesBitmap[i] );
    };
  };
	lcd->setCursor(0,0);
}
...
static void HD44780AnimatedBar::init( 	hd44780_I2Cexp& llcd, 
										HD44780AnimatedBar::bar_type_t barType = BAR_LINES) {
